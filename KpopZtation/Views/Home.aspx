        ...
        <asp:Panel ID="Home_ArtistData" runat="server" CssClass="Home_ArtistData">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-dark table-striped">
                <Columns>
                    ...
                    <asp:ImageField DataImageUrlField="ArtistImage" DataImageUrlFormatString="~/Assets/{0}" HeaderText="Artist Image" ControlStyle-Height="200px" ControlStyle-CssClass="object-fit-contain border rounded">
